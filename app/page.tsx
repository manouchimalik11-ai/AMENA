    ...
    <div style={{ minHeight: "100vh", background: "#f7f7f8", color: "#1a1a2e" }}>
      ...
      <section style={{ position: "relative", padding: "72px 24px 90px", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
          ...
          {(() => {
            const steps = [
              { titre: t.how.s1_title, desc: t.how.s1_desc, img: "https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=1000&fit=crop" },
