  ...
  return (
    <footer style={{ background: "#1a1a2e", color: "#aaa", padding: "36px 32px", textAlign: "center" }}>
      <div style={{ display: "flex", justifyContent: "center", gap: 28, marginBottom: 18, flexWrap: "wrap" }}>
        <Link href="#" style={{ color: "#aaa", textDecoration: "none", fontSize: 14 }}>FAQ</Link>
        <Link href="#" style={{ color: "#aaa", textDecoration: "none", fontSize: 14 }}>Contact</Link>
        <Link href="#" style={{ color: "#aaa", textDecoration: "none", fontSize: 14 }}>Conditions</Link>
